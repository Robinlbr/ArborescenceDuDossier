...
Rappelez vous, c'est au serveur que vous demanderez de fournir l'arborescence. Mais avant cela, vous avez besoin d'un script permettant de traiter le contenu de votre dossier.
 ...
 <p>Il vous faut installer https://github.com/AxelLy/ArborescenceDuDossier/blob/master/Config.js que vous mettrez à la racine de votre application. Cela vous permet de changer le nom du dossier par défaut.</p>
